//
// Created by frank on 16.07.16.
//
#ifndef AUTO_TRAX_PATH_PLANNING_RRT_UNIT_TEST_H
#define AUTO_TRAX_PATH_PLANNING_RRT_UNIT_TEST_H
...
// Default values
  ...
  public:
    RRTUnitTest(const ros::NodeHandle &nh, const OCGridParameterBag &parameters);
...
#endif //AUTO_TRAX_PATH_PLANNING_RRT_UNIT_TEST_H
